...
INSERT INTO `searchtobook` (`bookID`, `SearchDate`, `numberOfSearches`) VALUES (1,'2016-01-09',3),(1,'2016-07-07',1),(1,'2017-01-25',5),(2,'2016-07-09',2),(3,'2015-07-08',1),(4,'2015-04-05',7),(5,'2014-04-04',9),(6,'2015-07-08',23),(7,'2016-07-12',10),(8,'2016-07-14',32),(8,'2016-08-09',32),(8,'2017-01-03',33),(9,'2014-04-04',45),(9,'2015-07-08',43),(9,'2016-08-11',44),(10,'2016-02-23',11),(17,'2014-04-04',5),(17,'2015-07-08',4),(20,'2017-01-01',5),(21,'2014-04-04',3),(22,'2015-07-08',4),(23,'2017-01-01',5),(25,'2017-01-02',5),(29,'2015-06-29',6);
...
INSERT INTO `subjecttobook` (`nameSubject`, `domainID`, `bookID`) VALUES ('animals',1,1),('umanBuddy',2,1),('Innovative',8,2),('personal advice',7,2),('umanBuddy',2,2),('world',9,3),('animals',1,4),('umanBuddy',2,4),('culprits',10,5),('people',4,5),('personal advice',7,5),('songs',6,5),('umanBuddy',2,5),('Innovative',8,6),('people',4,6),('songs',6,6),('umanBuddy',2,7),('world',4,7),('flowers',1,8),('umanBuddy',2,8),('world',4,8),('flowers',1,9),('personal advice',7,9),('flowers',1,17),('personal advice',7,17),('dogs',1,18),('Innovative',8,18),('dogs',1,19),('recessive',8,19),('recessive',8,20),('recessive',8,25),('culprits',10,29),('Conformal',8,30);
...
INSERT INTO `user` (`userID`, `password`, `identityNumber`, `firstName`, `lastName`, `userStatus`, `subscriptionMethod`, `privilege`, `subscriptionRequest`, `finishDateOfSubscription`) VALUES ('1','1','123456789','a','a',0,0,1,0,'2017-05-05'),('10','kate111','123456789','Katerina','Kornblat',0,0,6,0,'2017-01-12'),('11','sagi111','111111111','Sagi','Entenberg',0,0,1,0,'2015-05-06'),('111','111','346343434','d','f',0,2,1,0,'2017-07-08'),('12','coral222','222222222','Coral','Carmeli',0,1,2,0,'2017-01-14'),('13','hen333','333333333','Hen','Saada',0,0,3,0,'2017-01-11'),('14','almog444','444444444','Almog','Yamin',0,0,4,0,'2016-12-12'),('15','kfir555','555555555','Kfir','Girshtain',0,2,5,0,'2016-11-12'),('16','avi6666','666666666','Avi','Sofer',0,0,6,0,'2017-05-12'),('17','mal777','777777777','Malci','Grosman',0,3,6,0,'2016-04-13'),('18','sha888','888888888','Sharon','Tidhar',0,0,1,0,'2016-09-06'),('19','sergei999','999999999','Sergei','Mazin',0,1,1,0,'2016-07-08'),('2','2','345324346','fd','df',0,2,2,0,'2017-07-08'),('3','3','436435345','fd','fdhdf',0,2,3,0,'2017-07-08'),('4','4','456435643','dfsd','dfh',0,2,4,0,'2017-07-08'),('5','5','463246363','sd','df',0,2,5,0,'2017-07-08'),('6','6','653568457','sd','df',0,2,6,0,'2017-07-08');
