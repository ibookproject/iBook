...
INSERT INTO `domain` (`domainID`, `domainName`) VALUES (1,'nature'),(2,'science'),(3,'madab'),(4,'Biography'),(5,'guide'),(6,'children'),(7,'health'),(8,'lifestyle'),(9,'fiction'),(10,'crime');
...
INSERT INTO `libraryworker` (`workerID`, `role`, `department`, `email`) VALUES (3,'3','library worker','3@gmail.com'),(4,'4','library worker','4@gmail.com'),(5,'5','library worker','5@gmail.com'),(6,'6','manager','6@gmail.com');
...
INSERT INTO `review` (`reviewID`, `reviewDate`, `reviewContent`, `reviewStatus`, `bookID`) VALUES (1,'2016-05-09','Good summary!',0,1),(2,'2016-05-04','excellent author',0,1),(3,'2015-06-07','One of the finest books made in recent years.',0,1),(4,'2016-05-06','He shines when it is his time to go back into the world.',0,2),(5,'2015-06-08','This is simply one of the best books ever made and I know.',1,3),(6,'2016-05-09','very boring book!',0,4),(7,'2015-06-07','awsome!!',0,4),(8,'2016-07-06','I have never seen such an amazing book since I saw The Shawshank Redemption.',0,12),(9,'2017-01-21','What makes this book one of the best ever made is the message it conveys.',0,1),(10,'2016-04-03','It is a simple book, yet it has an everlasting message.',0,14),(11,'2016-04-03','Set aside a little over two hours tonight and buy this book.',0,15),(12,'2015-04-23','Can Hollywood, usually creating things for entertainment purposes only, create art?',0,17),(13,'2016-04-03','While maintaining some of the poetic and moving dialogue of the novella',0,19),(14,'2015-11-15','The story begins with the trial of a young banker, Andy Dufrense, victimized by circumstantial evidence',0,18),(15,'2015-11-15','With work from vast array of talented scene designers, costume designers, composers, cinematographers.',0,12),(16,'2015-12-16','This book manages to redeem Hollywood in the eyes of people who feared it long lost in a dark sea of clichés and predictability.',0,12),(17,'2015-12-22','Firstly, its setting. The opening aerial shots of the prison are a total eye-opener. This is an amazing piece of architecture, strong and Gothic in design. Immediately, the prison becomes a character.',0,12),(18,'2015-11-28','With themes of faith and hope, there is a definite religious subtext to be found here.',0,12),(19,'2016-04-03','The reason I became a member of this database is because I finally found a book ranking that recognized the true greatness of this book.',0,1),(20,'2015-11-15','I was so impressed with how every single subplot was given a great deal of respect and attention from the author.',0,1),(21,'2015-01-09','One of my all time favorites.',0,1),(22,'2014-10-12','If you haven\'t read this book,GO AND buy IT NOW. ',0,3),(23,'2014-05-04','It is the story of Andy Dufresne, played by Tim Robbins and his time at Shawshank Prison. It is a perspective of what it is to be human and to have hope for the future even in the face of insurmountable adversity. ',0,23),(24,'2014-09-08','If there is a book by which other books should be judged.',0,25),(25,'2016-04-03','I don\'t know how to write a good book review so I guess telling you what I feel about it may do better.',0,27),(26,'2015-11-15','What I don`t like about it is the amount of cliches.',0,26),(27,'2014-10-12','There`s also some outstanding touches from author.',0,26);
...
INSERT INTO `searchtobook` (`bookID`, `SearchDate`, `numberOfSearches`) VALUES (1,'2016-01-09',3),(1,'2016-07-07',1),(2,'2016-07-09',2),(3,'2015-07-08',1),(4,'2015-04-05',7),(5,'2014-04-04',9),(6,'2015-07-08',23),(7,'2016-07-12',10),(8,'2016-07-14',32),(8,'2016-08-09',32),(8,'2017-01-03',33),(9,'2014-04-04',45),(9,'2015-07-08',43),(9,'2016-08-11',44),(10,'2016-02-23',11),(17,'2014-04-04',5),(17,'2015-07-08',4),(20,'2017-01-01',5),(21,'2014-04-04',3),(22,'2015-07-08',4),(23,'2017-01-01',5),(25,'2017-01-02',5),(29,'2015-06-29',6);
...
INSERT INTO `subject` (`domainID`, `nameSubject`) VALUES (1,'animals'),(1,'dogs'),(1,'flowers'),(2,'brain'),(2,'umanBuddy'),(3,'space'),(4,'people'),(4,'world'),(5,'Challenge Guide'),(5,'Dining Guide'),(5,'Fitness Guide'),(5,'Nature Guide'),(6,'songs'),(6,'tree'),(7,'personal advice'),(8,'Conformal'),(8,'Innovative'),(8,'recessive'),(9,'world'),(10,'culprits'),(10,'thiefs');
...
-- Dump completed on 2017-01-24  9:35:22
